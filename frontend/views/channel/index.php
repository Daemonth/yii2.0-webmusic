...
<section class="main-right">
	...
	<div class="rmtj">
		...
		<div class="hot_channel clearfix">
		  <?php foreach ($hotchannel as $hotchannels):?>
			<div class="chn-content_list clearfix b">
				<div class="chn-content_hover">
					<a href="<?= Url::to(['music', 'id'=>$hotchannels[ 'id']]); ?>">
						<div class="chn-left_content" style="background-image: url(&quot;<?php echo $ul?>static/img/<?php echo $hotchannels['img'];?>&quot;);">
							<div class="black-mask">

							</div> 
							<h4><?php echo $hotchannels['channelname'];?></h4> 
				...
				<div class="chn-right_content">
					...
					<?php foreach ($music as $musics):?>
						...
						if($musics['channelid']==$hotchannels['id']){
